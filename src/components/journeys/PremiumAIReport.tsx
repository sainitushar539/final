  ...
  return (
    <div className={`${shellClass} overflow-hidden bg-[#070b13] text-[#f5f7fb]`}>
      ...
      <div className="relative flex h-full flex-col">
        <header className="border-b border-white/[0.08] bg-[#090e18]/95 px-3 py-4 backdrop-blur sm:px-4 md:px-8">
          <div className="mx-auto flex max-w-7xl flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="min-w-0">
              ...
              <h1 className="text-[1.75rem] font-semibold tracking-normal text-white sm:text-3xl md:text-4xl">
            ...
            <div className="grid grid-cols-2 gap-2 sm:flex sm:flex-wrap sm:items-center md:justify-end">
              <div className="rounded-xl border border-white/[0.08] bg-[#101827] px-3 py-3 sm:px-4">
              ...
              <div className="rounded-xl border border-white/[0.08] bg-[#101827] px-3 py-3 sm:px-4">
                {typeof scoreValue === 'number' ? (
                  <div className="text-center sm:text-left">
                    <span className="inline-block rounded-full bg-[#2563eb]/[0.08] px-3 py-1.5 text-[10px] font-semibold text-[#2563eb]">
                      {scoreLabel}
                    </span>
                    <div className="mt-2 text-4xl font-extrabold leading-none text-white sm:text-5xl">{scoreValue}</div>
                    {scoreCaption && (
                      <p className="mt-2 text-xs leading-5 text-slate-400 sm:max-w-[180px]">{scoreCaption}</p>
                    )}
                  </div>
                ) : (
                  <>
              ...
              {onRetry && (
                <button
                  onClick={onRetry}
                  className="inline-flex h-11 w-full items-center justify-center rounded-xl border border-white/[0.08] bg-[#101827] text-slate-300 transition hover:border-[#d8b76a]/40 hover:text-white sm:w-11"
              ...
              {onClose && (
                <button
                  onClick={onClose}
                  className="inline-flex h-11 w-full items-center justify-center rounded-xl border border-white/[0.08] bg-[#101827] text-slate-300 transition hover:border-white/20 hover:text-white sm:w-11"
        ...
        <main ref={scrollRef} className="hide-scrollbar flex-1 overflow-y-auto scroll-smooth px-3 py-4 sm:px-4 md:px-8 md:py-7">
          <div className="mx-auto grid max-w-7xl gap-4 md:gap-5 lg:grid-cols-[240px_minmax(0,1fr)]">
            <aside className="min-w-0 space-y-3 lg:sticky lg:top-7 lg:self-start lg:space-y-4">
              <nav className="rounded-2xl border border-white/[0.08] bg-[#0d1422]/95 p-2 shadow-[0_18px_70px_-48px_rgba(0,0,0,.9)]">
                ...
                <div className="grid grid-cols-2 gap-2 lg:flex lg:flex-col lg:overflow-visible lg:px-0">
                  {navItems.map((item) => {
                    ...
                    return (
                      <a
                        ...
                        className={`group flex min-w-0 items-center gap-2.5 rounded-xl border px-3 py-2.5 text-sm font-medium no-underline transition lg:gap-3 lg:py-3 ${
                          isActive
              ...
              <div className="rounded-2xl border border-white/[0.08] bg-[#0d1422]/80 p-4">
              ...
              {advice && !loading && (
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-xl border border-[#d8b76a]/25 bg-[#d8b76a]/10 px-4 py-3 text-sm font-semibold text-[#f1d890] transition hover:border-[#d8b76a]/45 hover:bg-[#d8b76a]/15 hover:text-white"
                >
            ...
            <section className="min-w-0 rounded-2xl border border-white/[0.08] bg-[#0d1422]/95 p-3 shadow-[0_22px_90px_-58px_rgba(0,0,0,.95)] sm:p-4 md:p-5">
              {loading && !advice && (
              ...
              {advice && (
                <div className="[animation:reportFade_.35s_ease-out_both]">
                  <div className="mb-4 flex flex-col gap-3 rounded-xl border border-white/[0.08] bg-[#111a2a] px-3 py-4 sm:px-4 md:flex-row md:items-center md:justify-between">
                    <div className="min-w-0">
                      <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">Report Sections</p>
                      <p className="mt-1 break-words text-sm leading-6 text-slate-300">Strategic blueprint, business model context, execution strategy, and milestones</p>
                    </div>
                    <div className="inline-flex w-full items-center justify-center gap-2 rounded-lg border border-emerald-400/20 bg-emerald-400/10 px-3 py-2 text-xs font-semibold text-emerald-200 md:w-auto">
